        ...
        <template #header>
            <div class="bg-violet-950 bg-opacity-10 py-2 px-4 border-b border-zinc-300">
                <span class="text-lg flex items-center gap-2">
                    Endpoint Traffic by IP address
                    <span class="material-symbols-outlined text-base mt-0.5 cursor-default" v-tooltip.right="'Gain insights into how individual IP addresses are interacting with specific endpoints within your specific application, enabling you to Monitor individual user behavior, and Personalize user experiences.'">
                        info
                    </span>
                </span>
            </div>
