...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\OlsAccessLog>
 */
class OlsAccessLogFactory extends Factory
{
    protected $model = OlsAccessLog::class;
    /**
    ...
    {
        $serverId = Server::whereHas('applications')->where('web_server', 'ols')->inRandomOrder()->pluck('id')->first();
