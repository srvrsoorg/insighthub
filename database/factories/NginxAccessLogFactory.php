...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\NginxAccessLog>
 */
class NginxAccessLogFactory extends Factory
{
    protected $model = NginxAccessLog::class;
    /**
    ...
    {
        $serverId = Server::whereHas('applications')->where('web_server', 'nginx')->inRandomOrder()->pluck('id')->first();
